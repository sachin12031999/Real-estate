    ...
    return (
        <div className='featured'>
            ...
            <div className='container'>
                ...
                <div className='span-3 img-details'>
                    <div className='top'>
                        <h2>Vindhya House , Shivaji Nagar, Bhopal MP</h2>
                        <p>House for Sale</p>
                        <p className='price'>₹21 Crore</p>
                    </div>
                ...
                <div className='span-2 right-img-details'>
                    <p>A beautiful modern day home in the city with a full-size pool. Spacious and luxurious home located in top point of bhopal lake view. Including media room, workout facility, and built-in sauna. </p>
        ...
        <div className='container'>
                ...
                <div className='span-2 right-img-details order-7'>
                    <p>A beautiful modern day home in the city with a full-size pool. Spacious and luxurious home located in top of Bhopal van vihar. Including media room, workout facility, and built-in sauna. </p>
                    <button className='btn'>View Listing</button>
                </div>
